...
required file popup.html: PASS
required file popup.js: PASS
required file popup.css: PASS
required file icons/icon16.png: PASS
required file icons/icon32.png: PASS
...
icon16.png is 16x16: PASS
icon32.png is 32x32: PASS
icon48.png is 48x48: PASS
icon128.png is 128x128: PASS
icon128 has 96x96 artwork with 16 px transparent padding: PASS
background.js syntax check: PASS
popup.js syntax check: PASS
manifest.json is at ZIP root: PASS
ZIP contains icon128.png: PASS
